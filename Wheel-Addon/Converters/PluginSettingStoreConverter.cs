...
namespace WheelAddon.Converters
{
    public class PluginSettingStoreConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
        {
            ...
            if (type == null)
            {
                WheelHandler.HandlerLog(this, WheelHandler.PLUGIN_NAME, $"Plugin {path} not found", LogLevel.Error);
                return null!;
            }
            ...
            {
                WheelHandler.HandlerLog(this, WheelHandler.PLUGIN_NAME, $"Plugin {path} settings not found", LogLevel.Error);
                return null!;
            }
